	...
	<table id="dg" title="商品管理" class="easyui-datagrid"
	 ...
	 <thead>
	 	<tr>
	 		...
	 		<th field="smallType.id" width="100" align="center" formatter="formatSmallTypeId" hidden="true">所属小类id</th>
	 		<th field="smallType.name" width="100" align="center" formatter="formatSmallTypeName">所属小类</th>
	 		<th field="bigType.id" width="100" align="center" formatter="formatBigTypeId" hidden="true">所属大类id</th>
	 		<th field="bigType.name" width="100" align="center" formatter="formatBigTypeName">所属大类</th>
